						...
						<div class="row">
							 ...
							 <a href="">
					          <div class="info-box bg-blue">
					            ...
					            <div class="info-box-content">
					              <span class="info-box-text">Patient User</span>
							...
							<a href="">
					          <div class="info-box bg-orange">
					            <span class="info-box-icon push-bottom"><i class="material-icons">event_note</i></span>
					            <div class="info-box-content">
					        ...
					        <!--<div class="col-xl-4 col-md-6 col-12">
					          ...
					          <div class="info-box bg-purple">
					            <span class="info-box-icon push-bottom"><i class="material-icons">view_quilt</i></span>
					            <div class="info-box-content">
					              <span class="info-box-text">Vienna Category</span>
							 ...
							 <a href="">
					          <div class="info-box bg-success">
					            ...
					            <div class="info-box-content">
					              ...
					              <span class="info-box-number">$2350</span><span></span>
					              <div class="progress">
					                <div class="progress-bar width-60"></div>
					              </div>
					              <!-- <span class="progress-description">
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>VVV Voucher Survey</header>
                                    <div class="tools">
